...
public class AmpliacioP1 {
    ...
    public static void main(String[] args) {
        ...
        //Declarem variables
        int id, places, respostaIdioma, room, telf, tries, nFamilies =0;
        ...
        do {
            ...
            while (!inRange && tries < TRIES_MAX) {
                ...
                if (!inRange) System.out.println(ERROR_MSG);
                input.nextLine();
            }
