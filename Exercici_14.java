...
public class E14_FernandezC {
    ...
    public static void main(String[] args) {
        ...
        //get first male and female position
        int i = 0;
        do {
        ...
        //print winners with for loop
        System.out.print("\nMale WINNER:   ");
        for (int k = 0; k < dades[0].length; k++) {
            System.out.print(dades[winnerM][k] + " ");
        }
        System.out.println();
        System.out.print("Female WINNER: ");
        for (int k = 0; k < dades[0].length; k++) {
            System.out.print(dades[winnerF][k] + " ");
        }
        System.out.println();
    }
}
